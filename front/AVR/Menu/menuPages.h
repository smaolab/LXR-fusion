...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	//page 2 - Voice 2 - drum
	{
		//sub page 1
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_SKIP,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,TEXT_SKIP,
			PAR_COARSE2,	PAR_FINE2,	PAR_OSC_WAVE_DRUM2,	PAR_NONE,PAR_NONE,PAR_PREFILLED_PATTERN1,PAR_RANDOMFILL_PATTERN1,PAR_NONE
	...
	//page 3 - Voice 3 - drum
	{
		//sub page 1 
		{
			...
			PAR_COARSE3,	PAR_FINE3,	PAR_OSC_WAVE_DRUM3,	PAR_NONE,PAR_NONE,PAR_PREFILLED_PATTERN2,PAR_RANDOMFILL_PATTERN2,PAR_NONE
			//TEXT_COARSE,	TEXT_FINE,	TEXT_DRIVE,	TEXT_WAVEFORM,	
