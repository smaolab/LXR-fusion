...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	//page 1 - Voice 1
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,TEXT_EMPTY,
			PAR_COARSE1,	PAR_FINE1,	PAR_OSC_WAVE_DRUM1,	PAR_NONE,PAR_RND_VOICE1,PAR_PREFILLED_PATTERN0,PAR_RANDOMFILL_PATTERN0,PAR_NONE
		},
		//sub page 2 - Amp EG
		{
	...
	//page 2 - Voice 2 - drum
	{
		//sub page 1
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,TEXT_SKIP,
			PAR_COARSE2,	PAR_FINE2,	PAR_OSC_WAVE_DRUM2,	PAR_NONE,PAR_RND_VOICE2,PAR_PREFILLED_PATTERN1,PAR_RANDOMFILL_PATTERN1,PAR_NONE
	...
	//page 3 - Voice 3 - drum
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,TEXT_EMPTY,
			PAR_COARSE3,	PAR_FINE3,	PAR_OSC_WAVE_DRUM3,	PAR_NONE,PAR_RND_VOICE3,PAR_PREFILLED_PATTERN2,PAR_RANDOMFILL_PATTERN2,PAR_NONE
			//TEXT_COARSE,	TEXT_FINE,	TEXT_DRIVE,	TEXT_WAVEFORM,	
	...
	{
		{		
		TEXT_SHUFFLE,	TEXT_ROLL_SPEED,	TEXT_X_FADE,	TEXT_SAMPLE_RATE,			 TEXT_DIVIDE,	TEXT_LOOP,	TEXT_EMPTY,	TEXT_EMPTY,
		PAR_SHUFFLE,	PAR_ROLL,			PAR_MORPH,		PAR_VOICE_DECIMATION_ALL,		PAR_DIVIDE,	PAR_LOOP,	PAR_NONE,	PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
