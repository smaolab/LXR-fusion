...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	//page 1 - Voice 1
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_PREFILLED_PATTERN,TEXT_EMPTY,TEXT_EMPTY,
			PAR_COARSE1,	PAR_FINE1,	PAR_OSC_WAVE_DRUM1,	PAR_NONE,PAR_RND_VOICE1,PAR_PREFILLED_PATTERN0,PAR_NONE,PAR_NONE
		},
		//sub page 2 - Amp EG
		{
	...
	//page 2 - Voice 2 - drum
	{
		//sub page 1
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_SKIP,TEXT_PREFILLED_PATTERN,TEXT_EMPTY,TEXT_EMPTY,
			PAR_COARSE2,	PAR_FINE2,	PAR_OSC_WAVE_DRUM2,	PAR_NONE,PAR_NONE,PAR_PREFILLED_PATTERN1,PAR_NONE,PAR_NONE
	...
	//page 3 - Voice 3 - drum
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_SKIP,TEXT_PREFILLED_PATTERN,TEXT_EMPTY,TEXT_EMPTY,
			PAR_COARSE3,	PAR_FINE3,	PAR_OSC_WAVE_DRUM3,	PAR_NONE,PAR_NONE,PAR_PREFILLED_PATTERN2,PAR_NONE,PAR_NONE
			//TEXT_COARSE,	TEXT_FINE,	TEXT_DRIVE,	TEXT_WAVEFORM,	
	...
	//page 4 - Voice 4 - snare/clap
	{
		//sub page 1
		{
			TEXT_COARSE,TEXT_FINE,TEXT_NOISE,TEXT_MIX,TEXT_WAVEFORM,TEXT_PREFILLED_PATTERN,TEXT_EMPTY,TEXT_EMPTY,
			PAR_COARSE4,	PAR_FINE4,	PAR_NOISE_FREQ1,	PAR_MIX1,	PAR_OSC_WAVE_SNARE,	PAR_PREFILLED_PATTERN3,PAR_NONE,PAR_NONE	
		},
		//sub page 2
		{
	...
	//page 5 - Voice 5 - cymbal
	{
		//sub page 1
		{
			TEXT_COARSE,	TEXT_FINE, TEXT_WAVEFORM,TEXT_EMPTY,TEXT_PREFILLED_PATTERN	,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_COARSE5,	PAR_FINE5, 	PAR_WAVE1_CYM,	PAR_NONE,PAR_PREFILLED_PATTERN4,PAR_NONE,PAR_NONE,PAR_NONE		
		},
		//sub page 2
		{
			TEXT_ATTACK,	TEXT_DECAY,	TEXT_REPEAT,	TEXT_EG_SLOPE,		TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
	...
	//page 6 - Voice 6 - HH (FM)
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,TEXT_WAVEFORM,TEXT_EMPTY,TEXT_PREFILLED_PATTERN,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,		
			PAR_COARSE6,	PAR_FINE6,PAR_WAVE1_HH,	PAR_NONE,PAR_PREFILLED_PATTERN5,PAR_NONE,PAR_NONE,PAR_NONE			
		},
		//sub page 2 - amp eg
		{
	...
	//page 7 - Voice 6 - HH/Cymbal (FM) - same as voice 6 -> open hi hat
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,TEXT_WAVEFORM,TEXT_EMPTY,TEXT_PREFILLED_PATTERN,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,		
			PAR_COARSE6,	PAR_FINE6,PAR_WAVE1_HH,	PAR_NONE,PAR_PREFILLED_PATTERN6,PAR_NONE,PAR_NONE,PAR_NONE,			
		},
		//sub page 2 - amp eg
		{
			TEXT_ATTACK,	/*TEXT_DECAY_CLOSED,*/	TEXT_DECAY_OPEN,	TEXT_EG_SLOPE, 	TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
	...
	{
		{		
		TEXT_SHUFFLE,	TEXT_ROLL_SPEED,	TEXT_X_FADE,	TEXT_SAMPLE_RATE,			 TEXT_LOOP,	TEXT_EMPTY,	TEXT_EMPTY,	TEXT_EMPTY,
		PAR_SHUFFLE,	PAR_ROLL,			PAR_MORPH,		PAR_VOICE_DECIMATION_ALL,		PAR_LOOP,	PAR_NONE,	PAR_NONE,	PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
